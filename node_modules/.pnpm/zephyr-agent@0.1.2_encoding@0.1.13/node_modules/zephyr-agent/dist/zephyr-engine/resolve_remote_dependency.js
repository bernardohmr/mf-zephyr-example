...
const http_request_1 = require("../lib/http/http-request");
...
async function resolve_remote_dependency({ application_uid, version, platform, build_context, }) {
    const depUrl = (0, zephyr_edge_contract_1.ZE_API_ENDPOINT)() +
        `${zephyr_edge_contract_1.ze_api_gateway.resolve}/` +
        `${encodeURIComponent(application_uid)}/` +
        `${encodeURIComponent(version)}`;
    const resolveDependency = (0, http_request_1.parseUrl)(depUrl);
    if (platform) {
