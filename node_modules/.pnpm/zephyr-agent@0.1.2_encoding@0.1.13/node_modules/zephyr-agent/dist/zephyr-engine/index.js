...
const ze_build_assets_1 = require("../lib/transformers/ze-build-assets");
const ze_build_snapshot_1 = require("../lib/transformers/ze-build-snapshot");
const ze_create_manifest_1 = require("../lib/transformers/ze-create-manifest");
 ...
 */
class ZephyrEngine {
    get zephyr_dependencies() {
        var _a;
        return (0, ze_create_manifest_1.convertResolvedDependencies)((_a = this.federated_dependencies) !== null && _a !== void 0 ? _a : []);
    }
    ...
    static async create(options) {
        ...
        await (0, login_1.checkAuth)(ze.gitProperties);
...
https://docs.zephyr-cloud.io/features/remote-dependencies`,
    ...
    async upload_assets(props) {
        ...
        if (zephyr_engine.federated_dependencies) {
            const manifest = {
                filepath: zephyr_edge_contract_1.ZEPHYR_MANIFEST_FILENAME,
                content: (0, ze_create_manifest_1.createManifestContent)(zephyr_engine.federated_dependencies),
            };
            const manifestAsset = (0, ze_build_assets_1.zeBuildAssets)(manifest);
        ...
        const upload_options = {
            ...
            getDashData: (engine) => {
                ...
                return Object.assign(Object.assign({}, buildStats), { ze_envs: (engine || zephyr_engine).ze_env_vars || undefined, ze_envs_hash: (engine || zephyr_engine).ze_env_vars_hash || undefined });
            },
            assets: {
                assetsMap,
                missingAssets,
        ...
        await (0, app_deploy_result_cache_1.setAppDeployResult)(application_uid, {
            urls: [zephyr_engine.version_url],
            snapshot,
        });
        // Call deployment hook if provided
        if (((_a = props.hooks) === null || _a === void 0 ? void 0 : _a.onDeployComplete) && zephyr_engine.version_url) {
            try {
                ...
                logging_1.ze_log.upload('Warning: deployment hook failed', error);
            }
        }
