...
type ZephyrEngineBuilderTypes = 'webpack' | 'rspack' | 'repack' | 'vite' | 'rollup' | 'parcel' | 'astro' | 'unknown';
...
export declare class ZephyrEngine {
    ...
    snapshot_with_envs: Snapshot | null;
    ze_env_vars: Record<string, string> | null;
    ze_env_vars_hash: string | null;
